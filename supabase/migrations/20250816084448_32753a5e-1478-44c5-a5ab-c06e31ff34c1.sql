...
-- Add sample data for videos (with correct column structure)
INSERT INTO videos (label, video_url, file_name, file_size, file_type) VALUES
('Introduction to Computer Science Program', 'https://youtube.com/watch?v=demo1', 'intro_cs_program.mp4', 52428800, 'video/mp4'),
('Campus Tour - Modern Computing Labs', 'https://youtube.com/watch?v=demo2', 'campus_tour.mp4', 43741824, 'video/mp4'),
('Student Success Stories', 'https://youtube.com/watch?v=demo3', 'success_stories.mp4', 61865984, 'video/mp4'),
('Programming Fundamentals Workshop', 'https://youtube.com/watch?v=demo4', 'programming_workshop.mp4', 128974848, 'video/mp4'),
('Industry Partnership Programs', 'https://youtube.com/watch?v=demo5', 'industry_partnership.mp4', 32505856, 'video/mp4');
